...
export default async function DisputesPage() {
  ...
  const { data: snapshot } = await supabase
    ...
    .select("status, scoreAvg, scoreEQ, scoreEX, scoreTU")
  ...
  const { data: plan } = await supabase.rpc(
  ...
  // ─── Progress Logic ───
  const progress = !hasSnapshot ? 20 : !hasAnalyzer ? 45 : 70;

  const nextStep = !hasSnapshot
    ? { label: "Pull Epic Report", href: "/snapshot" }
    : !hasAnalyzer
    ...
    <main className="dispute-center">
      ...
      <section className="status-grid">
        <div className="status-card highlight">
          ...
          <Link href="/snapshot" className="status-action">
            <span>{hasSnapshot ? "View Report" : "Pull Report"}</span>
      ...
      <section className="tools-section">
        <div className="section-header">
          ...
          <p className="section-subtitle">
            Manage disputes when cleanup is required. Only use these tools if your action plan recommends it.
          </p>
        </div>
        ...
        <div className="tools-grid">
          <div className="tool-card featured">
            ...
            <p className="tool-description">
              Track your dispute letter campaigns across all three bureaus. Monitor progress and response times.
            </p>
            <Link href="/dashboard/disputes/generate" className="tool-button primary">
          ...
          <div className="tool-card">
            ...
            <p className="tool-description">
              Access AI-powered dispute templates customized for your specific credit items and violations.
            </p>
            <Link href="/dashboard/disputes/generate" className="tool-button">
          ...
          <div className="tool-card">
            ...
            <p className="tool-description">
              Review bureau responses and track deletion success rates. Monitor your dispute effectiveness.
            </p>
            <Link href="/dashboard/disputes/outcomes" className="tool-button">
      ...
      <section className="quick-actions">
        <div className="action-tile">
          ...
          <div className="action-content">
            ...
            <p className="action-text">Learn dispute best practices and compliance guidelines</p>
          </div>
          <Link href="/dashboard/action-plan" className="action-link">Learn More</Link>
        </div>
        ...
        <div className="action-tile">
          ...
          <div className="action-content">
            ...
            <p className="action-text">Upload and manage proof documents for your disputes</p>
          </div>
          <Link href="/dashboard/analyzer/evidence" className="action-link">Manage</Link>
        </div>
      </section>
      ...
      <div className="disclaimer">
        ...
        <p>
          ...
          Always verify accuracy before submitting disputes. Frivolous disputes may damage your credit.
        </p>
      </div>
    </main>
  );
